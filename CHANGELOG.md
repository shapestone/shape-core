...
- Format enumeration (FormatJSONV, FormatXMLV, FormatYAMLV, etc.)
...
- [shape-jsonv](https://github.com/shapestone/shape-jsonv) - JSON validation format
- [shape-yamlv](https://github.com/shapestone/shape-yamlv) - YAML validation format
- [shape-csvv](https://github.com/shapestone/shape-csvv) - CSV validation format
- [shape-xmlv](https://github.com/shapestone/shape-xmlv) - XML validation format
- [shape-textv](https://github.com/shapestone/shape-textv) - Text pattern validation
