...
### Security
- Updated lychee-action from v1 to v2.0.2 to fix CVE-2024-48908 (arbitrary code injection vulnerability)
...
[0.9.2]: https://github.com/shapestone/shape-core/releases/tag/v0.9.2
[0.9.1]: https://github.com/shapestone/shape-core/releases/tag/v0.9.1
