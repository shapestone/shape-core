...
git add .
git commit -m "Add format detection interface improvements"

# Push to remote
git push -u origin feature/add-format-detection

# Create PR to develop
gh pr create --base develop --title "Improve format detection interface" --body "Description..."
...
3. **Descriptive branch names** - `feature/add-tokenizer-enhancement` not `fix-bug`
