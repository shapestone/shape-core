...
│   └── parser/
│       # Note: Format-specific parsers are in separate parser projects
...
**What NOT to Migrate:**
- `df/json/` - Format-specific tokenizers are in parser projects
- `df/scenario/` - Not relevant to shape
- `parsers/` - Parser projects implement their own parsers
