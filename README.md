...
### Parser Interface
- **Format enum:** Standard format identifiers (FormatJSONV, FormatXMLV, etc.)
- **Parser interface:** Common interface for all parser implementations
...
**Data Format Parsers** (for validating data):
...
**Validation Schema Parsers** (for parsing validation schemas):
- [shape-jsonv](https://github.com/shapestone/shape-jsonv) - JSON Validation schemas
- [shape-xmlv](https://github.com/shapestone/shape-xmlv) - XML Validation schemas
- [shape-yamlv](https://github.com/shapestone/shape-yamlv) - YAML Validation schemas
- [shape-csvv](https://github.com/shapestone/shape-csvv) - CSV Validation schemas
- [shape-textv](https://github.com/shapestone/shape-textv) - Text Validation schemas
- [shape-props](https://github.com/shapestone/shape-props) - Properties Validation schemas
...
```
┌──────────────────────────────────────────────────────────┐
│         Parser Projects (jsonv, xmlv, yamlv, etc.)       │
│           Data Format Validators (json, yaml, csv)       │
└──────────────────────┬───────────────────────────────────┘
                       │ depends on
                       ▼
       ┌────────────────────────────────────────┐
...
- `Format` - Format enum (FormatJSONV, FormatXMLV, etc.)
- `Parser` - Common interface for all parsers
...
- Data format validators (JSON, YAML, CSV, XML)
- Validation schema parsers (JSONV, XMLV, YAMLV, etc.)
...
- ✅ Parser interface and Format enum
- ✅ Schema validator framework
- ✅ 95%+ test coverage
