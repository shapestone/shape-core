...
- **Cross-format consistency**: Verify different formats produce same AST for equivalent schemas
...
- **Parser Verification**: Validates format parsers in parser projects
